  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Define the phases and tasks to execute your ESG plan.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {phases.length === 0 && !isEditing && (
          <p className="text-sm text-muted-foreground">
            No implementation phases defined for this plan.
          </p>
        )}
        {(phases.length > 0 || isEditing) && (
                            ...
                            {isEditing && (
                              <TableCell className="text-right">
                                <Button
                                  variant="ghost"
                                  size="icon"
                                  onClick={() => onEditTask(task, phase.id)}
